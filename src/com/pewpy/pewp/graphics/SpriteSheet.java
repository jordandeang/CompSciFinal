...
public class SpriteSheet {
	...
	public static SpriteSheet foresttiles = new SpriteSheet("/textures/foresttiles.png", 256);
	public static SpriteSheet boss = new SpriteSheet("/textures/boss_sprite.png",225);
